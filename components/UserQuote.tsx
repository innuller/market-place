      ...
      <div className="w-2/3 p-4">
        {selectedQuote ? (
          <>
            ...
            <ScrollArea className="h-[calc(100vh-24rem)] mb-4" style={{ background: 'transparent' }}>
            ...
            <div className="flex" style={{ background: 'transparent' }}>
              <Textarea
                ...
                className="flex-grow bg-[#003853] text-white placeholder:text-white/50 border-white/20 mr-2 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
                style={{ background: '#003853' }}
              />
