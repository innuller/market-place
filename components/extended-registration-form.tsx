...
const formSchema = z.object({
  ...
  annualTurnover: z.string().min(1, "Annual turnover is required").optional(),
  forecastEBITA: z.string().min(1, "Forecast EBITA is required").optional(),
  currentRatio: z.string().min(1, "Current ratio is required").optional(),
  inventoryTurnover: z.string().min(1, "Inventory turnover is required").optional(),
  bankName: z.string().min(1, "Bank name is required").optional(),
  bankBranchAddress: z.string().min(1, "Bank branch address is required").optional(),
